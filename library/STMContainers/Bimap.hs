...
{-# INLINABLE lookup1 #-}
lookup1 :: (Eq a, Hashable a) => a -> Bimap a b -> STM (Maybe b)
lookup1 k = Map.lookup k . m1

-- |
-- Look up a left value by a right value.
{-# INLINABLE lookup2 #-}
lookup2 :: (Eq b, Hashable b) => b -> Bimap a b -> STM (Maybe a)
lookup2 k = Map.lookup k . m2

-- |
-- Insert an association by a left value.
{-# INLINABLE insert1 #-}
insert1 :: (Eq a, Eq b, Hashable a, Hashable b) => b -> a -> Bimap a b -> STM ()
...
{-# INLINABLE insert2 #-}
insert2 :: (Eq a, Eq b, Hashable a, Hashable b) => a -> b -> Bimap a b -> STM ()
insert2 b a (Bimap m1 m2) = (inline insert1) b a (Bimap m2 m1)

-- |
-- Delete an association by a left value.
{-# INLINABLE delete1 #-}
delete1 :: (Eq a, Eq b, Hashable a, Hashable b) => a -> Bimap a b -> STM ()
...
{-# INLINABLE delete2 #-}
delete2 :: (Eq a, Eq b, Hashable a, Hashable b) => b -> Bimap a b -> STM ()
...
{-# INLINABLE focus1 #-}
focus1 :: (Eq a, Eq b, Hashable a, Hashable b) => Focus.StrategyM STM b r -> a -> Bimap a b -> STM r
...
-- or update it and return the new value.
{-# INLINABLE focus2 #-}
focus2 :: (Eq a, Eq b, Hashable a, Hashable b) => Focus.StrategyM STM a r -> b -> Bimap a b -> STM r
